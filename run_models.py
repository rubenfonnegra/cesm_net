...
def main(): 
    ...
    # Custom configs
    ### Main adv loss
    parser.add_argument("--model", help="Model to use.", default = None, choices=["UNet", "GAN"])

    # Dataset params
    parser.add_argument("--projection", type=str, default="MLO", help="Projection in which mammograms were taken")
