...
# Experiment Unet CC
python3 run_models.py --gpus 0 --dataset_name cesm --projection CC --epoch 200 --exp_name unet_CC_bg_30_01 --data_dir Data/cesm_patches/borde_bg_30/ --image_size 256 --channels 1 --batch_size 30 --n_epochs 401 --workers 12 --sample_interval 20 --checkpoint_interval 50 --model UNet
