...
# Experiment Unet CC
#python3 run_models.py --gpus 0 --dataset_name cesm --projection CC --exp_name unet_CC_bg --data_dir Data/cesm_patches/borde_bg_20/ --image_size 256 --channels 1 --batch_size 30 --n_epochs 201 --workers 12 --sample_interval 100 --checkpoint_interval 50 --model UNet
