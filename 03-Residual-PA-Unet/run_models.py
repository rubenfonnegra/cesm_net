...
def main(): 
    ...
    # Configs  
    parser.add_argument("--exp_name", type=str, default="Prueba_1", help="name of the experiment")
    parser.add_argument("--gpus", type = str, default = "0", help="GPUs to use")
    parser.add_argument("--data_dir", type = str, default = "/media/labmirp/Datos/workspaces/cesm_net/Data/cesm_patches/borde_bg_30/", help="Data dir path")
