...
from models.SA_Unet import SA_Unet_v1, SA_Unet_v2
from models.residual_PA_Unet import RPA_Unet_Generator
from models.ried_net import *
...
class riedNet(pl.LightningModule):
    def __init__(self, config, actOut):
        super().__init__()

        self.model  = RIEDNet( in_channels = config.channels, actOut = actOut)
        self.config = config
